...
@section('pagename', 'Employee Section')
    ...
    <div class="col-span-12">
        <div class="box">
            <div class="box-header">
                ...
                <a href="{{ route('add-employee') }}" type="button" class="ti-btn ti-btn-success" style="float:right;">Add New
                    Employee</a>
            </div>
            <div class="box-body">
                <div class="overflow-auto table-bordered">
                    <div id="employee-table" class="ti-custom-table ti-striped-table ti-custom-table-hover tabulator"
...
@section('custom-scripts')
    <script>
        ...
        function editAction(id) {
            window.location.href = "{{ route('modify-employee', '') }}" + "/" + id;
        }
        ...
        function changeStatus(id, status, element) {
            const url = "{{ route('change-employee-status') }}";
