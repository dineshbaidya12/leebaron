    ...
    <div class="col-span-12">
        <div class="box">
            <div class="box-header">
                ...
                <a href="{{ route('add-faq') }}" type="button" class="ti-btn ti-btn-success" style="float:right;">Add New
                    Faq</a>
            </div>
            <div class="box-body">
                <div class="overflow-auto table-bordered">
                    <div id="faq-table" class="ti-custom-table ti-striped-table ti-custom-table-hover tabulator"
...
@section('custom-scripts')
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            //Basic Tabulator
            var table = new Tabulator("#faq-table", {
                width: 150,
                minWidth: 100,
                layout: "fitColumns",
                pagination: "local",
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(cell, formatterParams, onRendered) {
                            ...
                            // if (rowData.status == 'active') {
                            //     statusIcon =
                            //         "<button type=\"button\" class=\"ti-btn bg-yellow-500 text-white hover:bg-yellow-600 focus:ring-yellow-500 dark:focus:ring-offset-white/10\"><i class='ti ti-bulb-filled'></button>";
                            // } else {
                            //     statusIcon =
                            //         "<button type=\"button\" class=\"ti-btn bg-gray-500 text-white hover:bg-gray-600 focus:ring-gray-500 dark:bg-black/20 dark:hover:bg-black/30 dark:focus:ring-offset-white/10\"><i class='ti ti-bulb-off'></button>";
                            // }

                            // var statusBtn =
                            //     '<button type="button" class="ti-btn bg-gray-500 text-white hover:bg-gray-600 focus:ring-gray-500 dark:bg-black/20 dark:hover:bg-black/30 dark:focus:ring-offset-white/10">' + statusIcon +
                            //     '</button>';
        ...
        function editAction(id) {
            window.location.href = "{{ route('modify-faq', '') }}" + "/" + id;
        }
        ...
        function changeStatus(id, status, element) {
            const url = "{{ route('changeFaqStatus', '') }}";
