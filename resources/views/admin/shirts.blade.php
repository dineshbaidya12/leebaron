...
@section('title', 'Online Shirt')
@section('pagename', 'Online Shirt')
    ...
    <div class="col-span-12">
        <div class="box">
            <div class="box-header">
                ...
                <a href="{{ route('add-shirt') }}" type="button" class="ti-btn ti-btn-success" style="float:right;">Add
                    New Shirt</a>
            </div>
            <div class="box-body">
                <div class="overflow-auto table-bordered">
                    <div id="shirt-table" class="ti-custom-table ti-striped-table ti-custom-table-hover tabulator"
...
@section('custom-scripts')
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            //Basic Tabulator
            var table = new Tabulator("#shirt-table", {
                width: 150,
                minWidth: 100,
                layout: "fitColumns",
                pagination: "local",
        ...
        function editAction(id) {
            window.location.href = "{{ route('modify-shirt', '') }}" + "/" + id;
        }
                    ...
                    fetch("{{ route('delete-shirt') }}", {
                        ...
                        .then(response => {
                            if (response.ok) {
                                ...
                                notifier.success('Shirt Deleted Successfully!')
                            } else {
                                var notifier = new AWN({
                                    position: 'top-right',
                                });
        ...
        function changeStatus(id, status, element) {
            const url = "{{ route('change-shirt-status', '') }}";
